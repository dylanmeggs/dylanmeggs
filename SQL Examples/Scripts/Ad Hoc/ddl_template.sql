...
(
    ...
    is_behavior_correct                   varchar(6),
    incorrect_behavior                    varchar(114),
    correct_behavior                      varchar(123),
    ...
    score_deprecated                      numeric(18) encode az64,
